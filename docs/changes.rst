...
* :ref:`Suggestions <suggestions>` are shown in the :ref:`zen-mode` and can be accepted, rejected, or voted on in place, with a :ref:`profile preference <profile-preferences>` to hide them.
